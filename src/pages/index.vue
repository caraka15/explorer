  ...
  <div class="">
    <div class="flex md:!flex-row flex-col items-center justify-center mb-6 mt-14 gap-2">
      <div class="w-16 rounded-full">
        <img class="w-20 h-20" src="../../public/logo.png" />
      </div>
      <h1 class="text-orange-500 dark:invert text-3xl md:!text-6xl font-bold">
        CrxaNode Dashboard
      </h1>
    </div>
    <div class="text-center text-base">
      <p class="mb-1">
        CrxaNode Dashboard is not just an explorer but also a wallet and more ... 🛠
      </p>
    </div>
    <div
    ...
    <div v-if="featured.length>0" class="text-center text-base mt-6 text-orange-500">
    ...
    <div class="text-center text-base mt-6 text-orange-500">
