...
const showDiscord = window.location.host.search('explorer.crxanode.com') > -1;
...
<template>
  <div class="bg-gray-100 dark:bg-[#171d30]">
    <!-- sidebar -->
    <div
      class="w-64 fixed z-50 left-0 top-0 bottom-0 overflow-auto bg-base-100 border-r border-orange-500 dark:border-gray-700"
    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <div
            class="collapse-title !py-0 px-4 flex items-center cursor-pointer hover:bg-orange-500 dark:hover:bg-orange-500"
          >
            <Icon
              v-if="item?.icon?.icon"
              :icon="item?.icon?.icon"
            ...
            <div
              ...
              class="mr-6 badge badge-sm bg-orange-500 text-white border-none"
          ...
          <div class="collapse-content">            
            <div v-for="(el, key) of item?.children" class="menu bg-base-100 w-full !p-0">
              <RouterLink
                v-if="isNavLink(el)"
                @click="sidebarShow = false"
                class="hover:bg-orange-500 dark:hover:bg-orange-500 rounded cursor-pointer px-3 py-2 flex items-center"
                :class="{
                  'bg-orange-500': selected($route, el),
                }"
                :to="el.to"
              >
                <Icon
            ...
            <div v-if="index === 0 && dashboard.networkType === NetworkType.Testnet" class="menu bg-base-100 w-full !p-0">
              <RouterLink 
              class="hover:bg-orange-500 dark:hover:bg-[#373f59] rounded cursor-pointer px-3 py-2 flex items-center"
        ...
        <RouterLink
          ...
          :to="item?.to"
          @click="sidebarShow = false"
          class="cursor-pointer rounded-lg px-4 flex items-center py-2 hover:bg-orange-500 dark:hover:bg-[#373f59]"
        >
          <Icon
            v-if="item?.icon?.icon"
            :icon="item?.icon?.icon"
          ...
          <div
            v-if="item?.badgeContent"
            class="badge badge-sm bg-orange-500 text-white border-none" 
            :class="item?.badgeClass"
          >
            {{ item?.badgeContent }}
          </div>
      ...
      <div class="px-2">
          ...
          class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-orange-500 dark:hover:bg-orange-500"
          >
        ...
        <a
          ...
          target="_blank"
          class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-orange-500 dark:hover:bg-[#373f59]"
        >
          <img
        ...
        <a
          ...
          target="_blank"
          class="py-2 px-4 flex items-center rounded-lg cursor-pointer hover:bg-orange-500 dark:hover:bg-[#373f59]"
        >
